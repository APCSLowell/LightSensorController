...
When you are happy with your program, have a friend make short video less than 10 seconds in length of you interacting with your virtual pet. Convert the video to an animated gif using a free converter like [ezgif.com](https://ezgif.com/). Put the animated gif on the web using a free hosting service like [https://gifyu.com/](https://gifyu.com/). Submit the URL of your gif to Google Classroom. See Mr. Simon's example animated gif below.
